...
public class Deanery {
    ...
    public void writeToConsole(){
        for (Group group: groups){
            System.out.println("\n\nGroup title: " + group.getTitle() + "\n  Average rating of the group: " + group.averageMarkGroup() );
            System.out.println("\n   Group headman is: " + group.getHead().getFio()  + "\n");
            System.out.println("   Students in group: " + group.students.size());
            System.out.println("   * Student's name * _ _ _ _ _ _  * Average student score *");
            for (Student student: group.getStudents()) {
                System.out.println( "   " + student.getFio() + " _ _ _ _ _ _ _ _ _ " + student.averageMark());
            }
        }
    }
